...
, function(e, t, n) {
    ...
    var sn = "chat.zalo.me" == window.location.host || "dev.chat.zalo.me" == window.location.host
      , cn = {
        ...
        nameCheckRegex: "\\b(cặt|cặc|con\\s+cac|lồn|lon\\s+me|bu\\s+lon|đụ|du\\s+ma|djt|dit|địt|đéo\\s+mẹ|cứt|ỉa|(s)+e(x)+|chết\\s+mẹ|đái|du nha|fuck|di (khach san|hotel|ks|ksan)|xx(x)+|(thu|thủ) (dam|dâm)|(lam|làm) (tinh|tjnh|tình)|(bu|pu) (lon|kac|ti|tj|cu)|loz|mat day|f.u.c.k|nứng|con pho|bú|bu'|liếm|chịch|liem lon|Chat show|chat sexy|chjm|Tình Dục|Do cho cai|con diem|pha (trjnh|trinh)|nung lon|ban dam|(thương|thuong)\\s*(yêu|yeu)|(yêu|yeu)\\s*(thương|thuong)|(tin)\\s*(nhắn|nhan)|(nhắn|nhan|gửi|gui)\\s*(nhắn|nhan|gửi|gui|tin)|mua dam|Đĩ|Điếm|phò|matxa|(giải|giai|trúng|trung|trao|nhận|nhan)\\s*(thưởng|thuong)|(khuyến|khuyen)\\s*(mãi|mai)|(ban)?(quản|quan|quãn)\\s*(trị|tri|trj|trịị|trii)(viên|vien|vjen|mang|mạng)?|(ban)?(quản|quan|quãn)\\s*(lý|ly|li|lí)(viên|vien|vjen|mang|mạng)?|(ban)?(tổ|to)\\s*(chức|chuc)|admin|adm|(hệ|he|hê)\\s*(thống|thong|thông)|âm đạo|bisexual|ca\\s*ve|bựa|chó|cmnr|hiếp|đảng cộng sản|dcm|bộ đội|les|(ban)?(quản|quan|quãn)\\s*(viên|vien|vjen|mang|mạng)|(bộ|bo|bọ)\\s*(truyền|truyen)\\s*(thông|thong)|(chúc|chuc)\\s*(mừng|mung)\\s*(bạn|ban)?|id|(mùa|mùa|mua)\\s*(lễ|le)\\s*(hội|hoi)|(nhận|nhan)\\s*(quà|qua)\\s*(hot)|(tin)\\s*(mới|moi|nhanh|tuc|tức|nhan|nhắn)|(ban|bản|bảng|bang)\\s*tin|(bốc|boc|bóc)\\s*(thăm|tham)|may\\s*(mắn|man)|(trao|nhận|nhan)\\s*(giai|giải)|(kết|kêt|ket)\\s*(quả|qua)|(tai|tài)\\s*(khoan|khoản)(vip)?|(phát|phat|trao|tặng|tang|tăng|nhận|nhan)\\s*(quà|qua)|(quà|qua)\\s*(tang|tặng)|tàu khựa|việt cộng|việt nam cộng hòa|đàm vĩnh hưng|dam vinh hung|hồ ngọc hà|ho ngoc ha|đan trường|dan truong|nạp tiền|tam sa|hồ sơ|(công|cong)\\s*(an|ty)|hồ chí minh|ho chi minh|tư vấn|(nhân|nhan)\\s*(viên|vien)|moderator|ngụy|nhục|nô lệ|support|(ban)?(thông|thong)\\s*(báo|bao|tin|tjn)|(sự|su)\\s*(kiện|kien)|tri\\s*(ân|an)|(khách|khach)\\s*(hàng|hang)|(mạng|mang)\\s*(xã|xa)\\s*(hội|hoi)|nhà\\s*mạng|truyền\\s*thông|evn\\s*telecom|vietnam\\s*mobile|gm|(hỗ|ho|hổ)\\s*(trợ|tro)(vien|viên)?|z\\s*a\\s*l\\s*o|(tổng|tong)\\s*(đài|dai)|vina\\s*game|zing\\s*alo|vip|(tuần|tuan)\\s*(lễ|le)\\s*(vàng|vang)|trang\\s*(chu|chủ)|báo\\s*tin|tin\\s*báo|nhận\\s*xe|so\\s*cute|so\\s*kute|chăm\\s*sóc|(chương|chuong)\\s*(trình|trinh)|quà\\s*(tháng|quý|tuần|ngày|năm|tết|tet)|phần\\s*thưởng|triển\\s*khai\\s*chương\\s*trình|phát\\s*thanh\\s*viên|(tải|tin)\\s*ứng\\s*dụng|thông\\s*tấn\\s*xã|tin\\s*trực\\s*tuyến|ban\\s*điều\\s*hành|sự\\s*kiện|tavet|xoạc|đi\\s*kháck|mút|se\\s*x|s\\s*ex|nện|phang|vét\\s*máng|sờ\\s*ti|buti|bú\\s*(lồn|cặc|tí|ti|lìn)|xoac|diack|mút\\s*(lồn|cặc|tí|ti,lìn)|nệ(n){1,}|phập|vét|dờ\\s*âm|bucu|gái\\s*gọi|nhà\\s*nghỉ|nha\\s*nghi|đikhách|sò\\s*lông|sexy|vếu|fập|máng|nhiều\\s*nước|buchim|callgirl|N\\s*N|ch\\s*ịch|c\\s*hịch|chị\\s*ch|tàu\\s*nhanh|se\\s*zy|nưn\\s*g|trym|phịt|chym|chịc\\s*xã\\s*giao|chịch|can\\s*tien|di\\s*khach|đikhách|đi\\s*khách|đi\\s*khach|se(x){1,}|s(e){1,}x(y){1,}|se(x){1,}y|ti\\s*em\\s*to|lốp\\s*to|lồn\\s*to|vếu\\s*to|vếu\\s*bự|chịc\\s*chịc|đi\\s*hotel|em\\s*sướng|sò\\s*lông|chịch\\s*chịch|chịch|địt|Ｔｉｎ\\s*Ｎｈắｎ\\s*Ｚａｌｏ|Zälo|Žalo|Zαɭo|Zαɭσ|Αpp\\s*Zαɭo|Zαɭσ\\s*Gold|(ban)?giám\\s*đốc)\\b"
    }
      , ln = n(40)
      , un = n.n(ln)
      , pn = n(72)
    ...
    var hn = fn
      , mn = {
        vn: {
            login_with_zalo: "Đăng nhập tài khoản Zalo",
            login_with_zalo_line_2: "để kết nối với ứng dụng",
            account: "Tài khoản",
            qr_code: "Với Mã QR",
            phone_number: "Số điện thoại",
            label_phone_number: "Với Số điện thoại",
            label_password: "Với mật khẩu",
            password: "Mật khẩu",
            login: "Đăng nhập",
            ...
            user_zalo_for_zalo_group: "Dùng tài khoản Zalo để truy cập các ứng dụng của ZA",
            scan_qr_for_login: "Quét mã QR bằng Zalo để đăng nhập",
            scan_qr_success: 'Quét mã thành công. Vui lòng chọn "Đăng nhập" trên thiết bị di động của bạn.',
            by_click_register: "Bằng cách bấm vào nút đăng ký, bạn đã đồng ý với",
            zalo_policy: "các điều khoản sử dụng của Zalo",
            send_active_code: "Nhận mã kích hoạt",
            resend_active_code: "Nhận lại mã kích hoạt",
            active_code_sent: "Mã kích hoạt đã được gửi đến số điện thoại:",
            active_code_resent: "Mã kích hoạt đã được gửi lại thành công.",
            please_try_again: "Vui lòng thử lại.",
            try_again: "Thử lại",
            next: "Tiếp tục",
            input_active_code: "Nhập mã kích hoạt",
            input_displayname: "Nhập tên bạn muốn hiển thị",
            gender: "Giới tính",
            female: "Nữ",
            male: "Nam",
            birhtday: "Ngày sinh",
            ...
            days: "ngày",
            ago: "trước",
            active_now: "Vừa truy cập",
            confirm_password: "Nhập lại mật khẩu",
            register: "Đăng ký",
            please_input_active_code: "Vui lòng nhập mã kích hoạt",
            please_input_birthday: "Vui lòng nhập ngày sinh hợp lệ",
            anwser_security_question: "Đây là lần đầu tiên bạn đăng nhập trên thiết bị này, để đảm bảo an toàn, vui lòng trả lời câu hỏi dưới đây:",
            confirm_login_new_device: "Xác minh đăng nhập trên thiết bị mới",
            zalo_account: "tài khoản Zalo",
            login_pc: "Đăng Nhập",
            zalo_pc: "Zalo PC",
            register_success: "Đăng ký tài khoản Zalo thành công",
            request_login: "Yêu cầu đăng nhập bằng Zalo",
            login_with_other: "Hoặc đăng nhập bằng tài khoản khác",
            qr_code_expired: "Mã QR hết hạn",
            reget_qr_code: "Lấy mã mới",
            relogin_with_avatar: "Nhấn vào hình đại diện để đăng nhập lại",
            select_3: "Chọn 3 đáp án",
            please_select_3: "Vui lòng chọn đủ 3 đáp án",
            anwser: "Trả lời",
            request_login_send: "Một yêu cầu đã được gửi đến ứng dụng Zalo trên điện thoại của bạn, vui lòng kiểm tra và xác nhận...",
            ask_for_request_login: "Nhập thông tin sai quá số lần quy định. Bạn có muốn gửi yêu cầu đăng nhập đến tài khoản này?",
            waiting_for_confirm: "Đang chờ xác nhận",
            agree: "Đồng ý",
            ignore: "Hủy bỏ",
            select_image: "Chọn ảnh",
            select_avatar_to_change: "Nhấn vào hình đại diện để thay đổi",
            please_input_displayname: "Vui lòng nhập tên hiển thị",
            password_no_space: "Mật khẩu không thể bắt đầu bằng khoảng trắng",
            password_length_error: "Mật khẩu phải có ít nhất 6 ký tự bao gồm cả chữ và số",
            password_confirm_wrong: "Mật khẩu xác nhận không chính xác",
            english: "English",
            vietnam: "Tiếng Việt",
            myanmar: "မြန်မာ",
            request_login_tab: "Yêu cầu<br>đăng nhập",
            request_login_intro: "Chúng tôi sẽ gửi một yêu cầu đăng nhập đến ứng dụng Zalo trên thiết bị của bạn.",
            connection_interrupted: "Kết nối bị gián đoạn, vui lòng thử lại.",
            phone_is_empty: "Vui lòng nhập số điện thoại hợp lệ.",
            or: "Hoặc",
            login_by_facebook: " Đăng nhập bằng Facebook",
            link_facebook_account: "Liên kết tài khoản Facebook",
            register_by_facebook: "Đăng ký bằng tài khoản Facebook",
            link_facebook_desc: "Tài khoản Facebook này chưa liên kết với một số điện thoại đã đăng ký Zalo. Vui lòng nhập số điện thoại của bạn để nhận mã liên kết.",
            mapping_code_empty: "Vui lòng nhập mã liên kết.",
            input_phone: "Vui lòng nhập số điện thoại.",
            input_password: "Vui lòng nhập mật khẩu.",
            receive_linking_code: "Nhận mã liên kết",
            linking_desc: "Chúng tôi vừa gửi mã liên kết tới Zalo trên thiết bị của bạn.<br/>Vui lòng nhập mã liên kết để tiếp tục:",
            linking_code: "Mã liên kết",
            link: "Liên kết",
            confirm_code: "Mã xác nhận",
            avatar_reach_max: "Kích thước hình đại diện vượt quá quy định",
            login_via_zaloapp: "Đăng nhập qua ứng dụng Zalo",
            forgot_password: "Quên mật khẩu",
            forgot_password_header: "Khôi phục mật khẩu Zalo",
            forgot_password_title: "Nhập số điện thoại để nhận mã xác thực",
            forgot_password_subTitle: "Xác nhận số điện thoại:",
            forgot_password_content: "Mã xác thực sẽ được gửi đến số điện thoại trên thông qua tin nhắn hoặc cuộc gọi từ Zalo. Vui lòng dùng mã xác thực này để đặt lại mật khẩu.",
            forgot_password_confirm_text: "Xác nhận",
            forgot_password_change: "Thay đổi",
            back: "Quay lại",
            forgot_recover_title: "Bạn sẽ nhận được tin nhắn có mã kích hoạt từ Zalo",
            forgot_recover_input_placeholder: "Nhập mã kích hoạt",
            forgot_recover_resend_authentication_code: "Gửi lại mã kích hoạt",
            forgot_recover_note: "Bạn sẽ nhận được mã kích hoạt trong 8 giây",
            phone_length_error: "Số điện thoại có ít nhất 6 chữ số",
            error_limit_send_request_code: "Kết nối bị gián đoạn, vui lòng thử lại sau",
            error_unregister_phone: "Số điện thoại này chưa được đăng ký tài khoản, vui lòng thử lại với số điện thoại khác",
            error_expired_activation_code: "Mã kích hoạt của bạn đã hết hạn, vui lòng tạo mã kích hoạt mới",
            activation_code_no_space: "Mã kích hoạt không thể bắt đầu bằng khoảng trắng",
            activation_code_length: "Mã kích hoạt chỉ chứa 6 số ký tự",
            btn_next: "Tiếp tục",
            btn_request_login: "Gửi yêu cầu đăng nhập",
            btn_login_with_pass: "Đăng nhập với mật khẩu",
            help_text_login_without_password: "Đăng nhập không dùng mật khẩu",
            help_text_or_login: "Hoặc đăng nhập bằng",
            help_text_back: "Quay lại",
            forgot_password_success_noti: "Bạn đã thay đổi mật khẩu thành công",
            forgot_password_success_system_text: "Hệ thống sẽ đưa bạn về trang đăng nhập sau",
            forgot_password_success_sec: "giây.",
            qr_code_android_tv_instruction: "Dùng điện thoại quét QR Code để đăng nhập",
            qr_code_android_tv_step1: "Bước 1",
            qr_code_android_tv_step2: "Bước 2",
            qr_code_android_tv_step3: "Bước 3",
            qr_code_android_tv_step1_title: "Mở ứng dụng Zalo và chọn tính năng Quét QR",
            qr_code_android_tv_step2_title: "Quét QR Code bên dưới",
            qr_code_android_tv_step3_title: "Xác nhận đăng nhập",
            password_length_error_30: "Mật khẩu chỉ chứa tối đa 30 ký tự",
            image_accept_error: "Chỉ được chọn hình ảnh có đuôi là .jpg, .jpeg hoặc .png",
            confirm_login: "Xác minh tài khoản Zalo",
            success_login: "Bạn đã đăng nhập Zalo",
            facebook_login: "Đăng nhập bằng Facebook",
            login_zalo_mobile: "Đăng nhập Zalo",
            rolled_by: "Phiên làm việc bị đăng xuất vì bạn đã đăng nhập quá số lượng thiết bị cho phép (lần đăng nhập cuối trên thiết bị {device} vào lúc {time})",
            kick_out_in_management_page: "Thiết bị này bị đăng xuất bởi trang quản lý thiết bị"
        },
        en: {
        ...
        mm: {
            ...
            login: "ရဲ့ login",
            login_by: "အတွက် Sign နှင့်အတူ",
            logout: "Logout",
            have_no_account: "အကောင့်တစ်ခုရှိသည်မဟုတ်လော",
            have_account: "သငျသညျပြီးသားအကောင့်တစ်ခုရှိသည်?",
            login_now: "အခုတော့ Login!",
            register_now: "အခုတော့ Register!",
            user_zalo_for_zalo_group: "Zalo applications များ Zalo Group မှဝင်ရောက်ဖို့အသုံးပြုသူအကောင့်",
            scan_qr_for_login: "Zalo လော့ဂ်ဖို့အတွက် QR code ကို scan",
            scan_qr_success: 'အောင်မြင်သောကုဒ်စကင်ဖတ်စစ်ဆေးဖို့။ သင့်မိုဘိုင်းစက်ပစ္စည်းတွင် "သင်္ကေတပြ" ကို select ပေးပါ။',
            by_click_register: "အဆိုပါမှတ်ပုံတင် button ကိုနှိပ်ခြင်းအားဖြင့်သင်သဘောတူ",
            zalo_policy: "Zalo အသုံးပြုမှု၏စည်းကမ်းချက်များ",
            send_active_code: "activation code ကို Send",
            resend_active_code: "အဆိုပါ activation code ကိုပြန်ပို့ပါ",
            active_code_sent: "သင့်ရဲ့ဖုန်းနံပါတ်သို့ပို့ activation ကုဒ်:",
            active_code_resent: "activation code ကိုအောင်မြင်စွာလှေတျတျောမူခဲ့သညျ။",
            please_try_again: "ထပ်ကြိုးစားပါ။",
            try_again: "ပြန်ကြိုးစား",
            next: "ဆက်လက်",
            input_active_code: "activation code ကိုရိုက်ထည့်ပါ",
            input_displayname: "သငျသညျပြသချင်သောအမည်အားထည့်သွင်းပါ",
            gender: "လိင်",
            female: "အမြိုးသမီး",
            male: "တောင်",
            birhtday: "မွေးသက္ကရာဇ်",
            day: "နေ့",
            month: "လ",
            year: "ခုနှစ်",
            hour: "နာရီ",
            ...
            second: "ဒုတိယ",
            ago: "လွန်ခဲ့တဲ့",
            confirm_password: "စကားဝှက်ကိုရိုက်ထည့်ပါ",
            register: "မှတ်ပုံတင်",
            please_input_active_code: "အဆိုပါ activation code ကိုရိုက်ထည့်ပေးပါ",
            please_input_birthday: "ခိုင်လုံသောမွေးနေ့ကိုရိုက်ထည့်ပေးပါ",
            anwser_security_question: "ဤသူသည်သင်တို့ကိုဤကိရိယာတွင်လက်မှတ်ထိုးပထမဦးဆုံးအကြိမ်ဖြစ်ပါသည်, ဘေးကင်းလုံခြုံရေးသေချာစေရန်အောက်ပါမေးခွန်းများကိုဖြေပါ",
            confirm_login_new_device: "အသစ်သောပစ္စည်းကိရိယာများအပေါ် log ကို Verify",
            zalo_account: "အကောင့် Zalo",
            login_pc: "လော့ဂ်အင်",
            zalo_pc: "Zalo အကောင့်နှင့်အတူ",
            register_success: "အကောင့်မှတ်ပုံတင်ခြင်းအောင်မြင်သော Zalo",
            request_login: "Zalo ခြင်းဖြင့်လိုအပ်သည့်ဝင်မည်",
            login_with_other: "သို့မဟုတ်အခြား account ကို sign in",
            qr_code_expired: "QR codes တွေကိုသက်တမ်းကုန်ဆုံး",
            reget_qr_code: "အသစ်သောကုဒ် Get",
            relogin_with_avatar: "နောက်တစ်ကြိမ်လော့ဂ်ရန်သင့်ကိုယ်ပွားပေါ်တွင်ကလစ်နှိပ်ပါ",
            select_3: "3 အဖြေကို Pick",
            please_select_3: "အပြည့်အဝ 3 အဖြေကို select လုပ်ပါ ကျေးဇူးပြု.",
            anwser: "အဖွေ",
            request_login_send: "တစ်ဦးကတောင်းဆိုမှုကိုသင့်ရဲ့ဖုန်းကို Zalo အပေါ် app ကိုစလှေတျခဲ့သညျ, စစျဆေးနှင့်အတည်ပြုပါ ...",
            ask_for_request_login: "မမှန်ကန်သောအချက်အလက်သတ်မှတ်ထားသောလည်းအကြိမ်ပေါင်းများစွာရိုက်ထည့်ပါ။ သင်ဤအကောင့်မှတောင်းဆိုမှုကိုရဲ့ login ပေးပို့ဖို့လိုသလား?",
            waiting_for_confirm: "စောင့်ဆိုင်းအတည်ပြုချက်ကို",
            agree: "သဘောတူညီခဲ့,",
            ignore: "Cancel",
            select_image: "' ဓါတ်ပုံကို Select လုပ်ပါ,",
            select_avatar_to_change: "' ကိုပြောင်းလဲရန်သင့်ကိုယ်ပွားပေါ်တွင်ကလစ်နှိပ်ပါ",
            please_input_displayname: "တစ်ဦး display ကိုအမည်ဖြင့် ကျေးဇူးပြု. ထည့်သွင်းပါ",
            password_no_space: "Passwords များကိုနေရာများနှင့်အတူစတင်မနိုင်",
            password_length_error: "Password ကိုအက္ခရာနှင့်နံပါတ်များအပါအဝင်အနည်းဆုံး 6 ဇာတ်ကောင်ပါဝင်ရပါမည်",
            password_confirm_wrong: "Password ကိုအတည်ပြုခြင်းမမှန်ကန်",
            english: "English",
            vietnam: "Tiếng Việt",
            myanmar: "မြန်မာ",
            request_login_intro: "ငါတို့သည်သင်တို့၏မိုဘိုင်းဖုန်းပေါ်မှာ Zalo application ကိုတောင်းဆိုမှုတစ်ခုရဲ့ login ပေးပို့ပါလိမ့်မယ်.",
            connection_interrupted: "Connection ပြတ်တောက်ခဲ့သည်, ထပ်ကြိုးစားကြည့်ပါ။",
            phone_is_empty: "ခိုင်လုံသောဖုန်းနံပါတ်ရိုက်ထည့်ပေးပါ။",
            or: "သို့မဟုတ်",
            login_by_facebook: "Facebook အနေဖြင့် Login",
            confirm_code: "အတည်ပြုရန်ကုတ်",
            login_via_zaloapp: "လျှောက်လွှာ Zalo သုံးပြီးအတွက်နိမိတ်လက္ခဏာ",
            forgot_password: "စကားဝှက်ကိုမေ့နေပါသလား",
            forgot_password_header: "စကားဝှက်ကိုပြန်လည်နာလန်ထူ Zalo",
            forgot_password_title: "အဆိုပါ authentication ကိုကုဒ်လက်ခံရရှိရန်ဖုန်းနံပါတ်ရိုက်ထည့်ပါ",
            forgot_password_subTitle: "ဖုန်းနံပါတ်အားအတည်ပြု:",
            forgot_password_content: "Authentication ကုဒ်သတင်းစကားကိုတဆင့်အထက်အရေအတွက်ကိုစလှေတျသို့မဟုတ် Zalo ကနေခေါ်ပါလိမ့်မည်။ သင့်ရဲ့စကားဝှက်ကို reset ဤကုဒ်ကိုသုံးပါ။.",
            forgot_password_confirm_text: "အတည်ပြု",
            forgot_password_change: "ပွောငျးလဲခွငျး",
            back: "ပြန်",
            forgot_recover_title: "သငျသညျ Zalo ကနေ activation code ကိုအတူသတင်းစကားကိုလက်ခံရရှိပါလိမ့်မယ်",
            forgot_recover_input_placeholder: "Activation code ကိုရိုက်ထည့်ပါ",
            forgot_recover_resend_authentication_code: "Activation code ကိုပြန်ပို့ပါ",
            forgot_recover_note: "သငျသညျ 8 စက္ကန့်များအတွက် activation code ကိုလက်ခံရရှိပါလိမ့်မယ်",
            phone_length_error: "ဖုန်းနံပါတ်ကအနည်းဆုံး 6 ဂဏန်းပါရှိသည်",
            error_limit_send_request_code: "အဆိုပါကွန်နက်ရှင် Interrupt ဖြစ်ပါသည်, နောက်မှထပ်ကြိုးစားပါ",
            error_unregister_phone: "ဒါကဖုန်းနံပါတ်အကောင့်များအတွက်မှတ်ပုံတင်မပါ, တစ်ဦးကွဲပြားခြားနားသောဖုန်းနံပါတ်နှင့်အတူ ကျေးဇူးပြု. ထပ်ကြိုးစားပါ",
            error_expired_activation_code: "Activation code ကိုသက်တမ်းကုန်သွားပြီ, အသစ်တစ်ခုကို activation code ကိုဖန်တီးကျေးဇူးပြုပြီး",
            activation_code_no_space: "Activation code ကိုကြားနေရာလွတ်နဲ့စတင်မနိုင်",
            activation_code_length: "Activation code ကိုသာဇာတ်ကောင် 6 အရေအတွက်ကများပါဝင်သည်",
            btn_next: "ဆက်လက်",
            ...
            help_text_or_login: "Or login with",
            help_text_back: "Back",
            forgot_password_success_noti: "သင်သည်သင်၏ password ကိုအောင်မြင်စွာပြောင်းလဲပြီ",
            forgot_password_success_system_text: "အဆိုပါစနစ်အားပြီးနောက် login page ကိုရောက်ပါလိမ့်မယ်",
            forgot_password_success_sec: "စက္ကန့်.",
            qr_code_android_tv_instruction: "အတွက်လက်မှတ်ရေးထိုးရန်သင့် QR ကုဒ်ကိုစကင်နာကိုသုံးပါ",
            qr_code_android_tv_step1: "အဆင့် 1",
            qr_code_android_tv_step2: "အဆင့် 2",
            qr_code_android_tv_step3: "အဆင့် 3",
            qr_code_android_tv_step1_title: "အဆိုပါ Zalo app ကိုဖွင့်ပါနှင့်ဖို့အတွက် QR Scan ကိုအင်္ဂါရပ်ကို select",
            qr_code_android_tv_step2_title: "အောက်က QR Code ကို scan",
            qr_code_android_tv_step3_title: "Sign-in ကိုအတည်ပြုခြင်း",
            password_length_error_30: "Password ကိုသာ 30 ကိုဇာတ်ကောင်များပါဝင်သည်",
            image_accept_error: ".jpg, တွေဖြစ်တဲ့ JPEG သို့မဟုတ် .png နှင့်အတူသာလျှင်ပုံရိပ်တွေကိုရွေးချယ်နိုင်ပါသည်။",
            confirm_login: "Verify your Zalo account",
            success_login: "သငျသညျပြီးသား Zalo သို့ logged နေကြတယ်",
            facebook_login: "Facebook ကိုအတူ Login",
            login_zalo_mobile: "Zalo နှင့်အတူ Login",
            rolled_by: "The session is logged out because you have logged in over the number of devices allowed (last login on device {device} at {time})",
            kick_out_in_management_page: "Thiết bị này bị đăng xuất bởi trang quản lý thiết bị"
        }
    }
